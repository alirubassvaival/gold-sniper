          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <Card className="fade-in bg-gray-900 border-gray-800 overflow-hidden">
              ...
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold text-white mb-3">Smart Dollar Entries</h3>
                <p className="text-gray-400 mb-4">Learn optimal entry points for XAUUSD trades based on USD strength analysis.</p>
            ...
            <Card className="fade-in bg-gray-900 border-gray-800 overflow-hidden">
              ...
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold text-white mb-3">Gold Market Trends</h3>
                <p className="text-gray-400 mb-4">Understand current market patterns and upcoming opportunities in gold trading.</p>
                <div className="flex items-center text-sm text-gray-500">
                  <Clock className="w-4 h-4 mr-2" />
            ...
            <Card className="fade-in bg-gray-900 border-gray-800 overflow-hidden">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-gray-400 mb-4">Master the art of position sizing and stop-loss placement for consistent profits.</p>
                <div className="flex items-center text-sm text-gray-500">
                  <Clock className="w-4 h-4 mr-2" />
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md">
                Professional gold trading signals with 93% accuracy. Join thousands of successful traders worldwide.
              </p>
